...
Project conventions and LiveKit workflow guidance: [`.cursor/rules/`](.cursor/rules/) (`.mdc` files). [AGENTS.md](AGENTS.md) is a short pointer for tools that expect that file; the substance is in `.cursor/rules/`.
